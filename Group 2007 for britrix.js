...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("AgUBPQgLgNAAgYIAAhGIgTAAIAAgRIAWgNIAMggIAYAAIAAAgIAqAAIAAAeIgqAAIAABGQAAAJAFAEQAFAEAIAAQAKAAAPgFIAAAeQgPAHgWAAQgXAAgLgMg");
	this.shape.setTransform(395.425,710.075);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgTBnIAAiTIAnAAIAACTgAgVhSQAAgUAVAAQAWAAAAAUQAAAJgGAGQgFAFgLAAQgVAAAAgUg");
	this.shape_1.setTransform(385.575,708.65);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AghBKQgLgCgLgEIAAghQALAFAOADQAOAEAMAAQAUAAAAgNQAAgEgDgDIgJgHIgSgJQgSgHgIgFQgIgGgDgIQgEgIAAgLQAAgUAPgLQAQgKAbAAQAaAAAaALIgNAdIgUgIQgKgDgKAAQgRAAAAAKQAAAFAGAEQAFAEATAIQARAHAIAGQAJAFADAIQAEAIAAALQAAAXgQAMQgPALgfAAQgQAAgLgCg");
	this.shape_2.setTransform(374.85,711.525);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgTBnIAAiTIAnAAIAACTgAgVhSQAAgUAVAAQAWAAAAAUQAAAJgGAGQgFAFgLAAQgVAAAAgUg");
	this.shape_3.setTransform(363.925,708.65);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgVBgIhCi/IAqAAIAkBxIAGAYIADATQACgMAIgfIAkhxIAqAAIhCC/g");
	this.shape_4.setTransform(351.025,709.275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgvA5QgUgUAAgkQAAgkASgUQATgUAgAAQAfAAASARQARASAAAgIAAASIheAAQAAARAKAKQAJAJAQAAQAOAAAMgCQAMgDANgGIAAAfQgLAFgMADQgMACgRAAQgjAAgUgTgAgRgnQgHAIgBAPIA3AAQAAgPgIgIQgHgIgNAAQgLAAgIAIg");
	this.shape_5.setTransform(334.3,711.525);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgTBnIAAjNIAnAAIAADNg");
	this.shape_6.setTransform(322.175,708.65);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgvA5QgUgUAAgkQAAgkATgUQASgUAgAAQAfAAASARQARASAAAgIAAASIheAAQABARAJAKQAJAJAQAAQAOAAAMgCQAMgDANgGIAAAfQgLAFgMADQgMACgRAAQgjAAgUgTgAgRgnQgHAIgBAPIA3AAQAAgPgHgIQgIgIgNAAQgMAAgHAIg");
	this.shape_7.setTransform(310.1,711.525);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgUBgIAAidIg0AAIAAgiICRAAIAAAiIg1AAIAACdg");
	this.shape_8.setTransform(294.325,709.275);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// Layer_5
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#586CC8").s().p("AqnD8IAAn2IVPAAIAAH2g");
	this.shape_9.setTransform(344.975,709.05);
	...
	mask._off = true;
	mask.graphics.p("EhfHBJcQkeAAkEhuQj8hqjCjDQjBjBhrj8QhukEAAkeMAAAhnDQAAkdBukEQBrj8DBjCQDCjDD8hqQEEhuEeAAMC+OAAAQEeAAEFBuQD7BqDCDDQDCDCBrD8QBuEEAAEdMAAABnDQAAEehuEEQhrD8jCDBQjCDDj7BqQkFBukeAAg");
	mask.setTransform(749,470);

	// Layer_3
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#596BC8").s().p("Eg8kAdSMAAAg6jMB5JAAAMAAAA6jg");
	this.shape_10.setTransform(536.625,485.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#2BBC8D").s().p("A+pdSMAAAg6jMA9TAAAMAAAA6jg");
	this.shape_11.setTransform(1160.375,485.5);

	this.instance = new lib.Image();
	this.instance.setTransform(0,0,0.2601,0.2599);

	var maskedShapeInstanceList = [this.shape_10,this.shape_11,this.instance];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.shape_11},{t:this.shape_10}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ClipGroup, new cjs.Rectangle(0,0,1497.9,940), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(749,470,1,1,0,0,0,749,470);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol4, new cjs.Rectangle(0,0,1498,940), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(0.3,0.05,0.7277,0.7266,0,0,0,0.4,0.1);
...
p.nominalBounds = new cjs.Rectangle(545,341.5,545.0999999999999,341.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"https://static.wixstatic.com/media/b7af9d_2f9635fcb65545598892512d137e2c38~mv2.png", id:"_50_img_3"},
		{src:"https://static.wixstatic.com/media/b7af9d_f477737a7f86474eba324fe4f95fd666~mv2.png", id:"_50_img_4"},
		{src:"https://static.wixstatic.com/media/b7af9d_a41d5081a5f741a89ff4a567ba5fbbd6~mv2.png", id:"_50_img_5"},
		{src:"https://static.wixstatic.com/media/b7af9d_a72e8ec81a984391a55dbc93932c6211~mv2.png", id:"Image"}
	],
	preloads: []
};
